...
function useInBetweenInserter() {
  ...
  const isInBetweenInserterDisabled = (0, _data.useSelect)(select => select(_store.store).getSettings().hasReducedUI || select(_store.store).__unstableGetEditorMode() === 'zoom-out', []);
  const {
