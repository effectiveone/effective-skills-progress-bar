...
export const __unstableSetEditorMode = mode => _ref20 => {
  let {
    dispatch,
    select
  } = _ref20;
...
export const insertBeforeBlock = clientId => _ref23 => {
  let {
    select,
    dispatch
  } = _ref23;
...
export const insertAfterBlock = clientId => _ref24 => {
  let {
    select,
    dispatch
  } = _ref24;
...
export const flashBlock = clientId => async _ref25 => {
  let {
    dispatch
  } = _ref25;
