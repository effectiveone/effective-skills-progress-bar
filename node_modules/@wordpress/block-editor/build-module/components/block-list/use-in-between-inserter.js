...
export function useInBetweenInserter() {
  ...
  const isInBetweenInserterDisabled = useSelect(select => select(blockEditorStore).getSettings().hasReducedUI || select(blockEditorStore).__unstableGetEditorMode() === 'zoom-out', []);
  const {
